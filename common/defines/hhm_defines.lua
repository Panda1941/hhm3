...
NDefines.NIndustrialOrganisation.FUNDS_FOR_SIZE_UP = 580									-- Funds needed for a MIO to increment its size and get points to unlock traits
NDefines.NIndustrialOrganisation.FUNDS_FOR_SIZE_UP_LEVEL_FACTOR = 220						-- How much each level mutliplies the funds for size up 
