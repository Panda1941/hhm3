...
NDefines.NProduction.BASE_FACTORY_EFFICIENCY_VARIANT_CHANGE_FACTOR = 30
...
NDefines.NIndustrialOrganisation.FUNDS_FOR_SIZE_UP = 650									-- Funds needed for a MIO to increment its size and get points to unlock traits
